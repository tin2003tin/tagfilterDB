...
TEST(Coding, Strings) {
    std::string s;
    PutLengthPrefixedDataView(&s, DataView(""));
    PutLengthPrefixedDataView(&s, DataView("foo"));
    PutLengthPrefixedDataView(&s, DataView("bar"));
    PutLengthPrefixedDataView(&s, DataView(std::string(200, 'x')));

    DataView input(s);
    DataView v;
    ASSERT_TRUE(GetLengthPrefixedDataView(&input, &v));
