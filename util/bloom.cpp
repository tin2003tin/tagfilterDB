...
class BloomFilterPolicy : public FilterPolicy {
  public:
    ...
    const char *Name() const override {
        return "tagfilterdb.BuiltinBloomFilter2";
    }

    void CreateFilter(const DataView *keys, int n,
    ...
    bool KeyMayMatch(const DataView &key,
                     const DataView &bloom_filter) const override {
