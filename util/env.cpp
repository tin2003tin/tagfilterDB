...
static Status DoWriteStringToFile(Env *env, const DataView &data,
...
Status WriteStringToFile(Env *env, const DataView &data,
                         const std::string &fname) {
    return DoWriteStringToFile(env, data, fname, false);
}

Status WriteStringToFileSync(Env *env, const DataView &data,
                             const std::string &fname) {
