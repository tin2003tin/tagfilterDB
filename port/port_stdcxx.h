...
#ifndef STORAGE_TAGFILTERDB_PORT_PORT_STDCXX_H_
#define STORAGE_TAGFILTERDB_PORT_PORT_STDCXX_H_

// port/port_config.h availability is automatically detected via __has_include
// in newer compilers. If TAGFILTERDB_HAS_PORT_CONFIG_H is defined, it overrides the
// configuration detection.
#if defined(TAGFILTERDB_HAS_PORT_CONFIG_H)

#if TAGFILTERDB_HAS_PORT_CONFIG_H
#include "port/port_config.h"
#endif // TAGFILTERDB_HAS_PORT_CONFIG_H
...
#endif // defined(TAGFILTERDB_HAS_PORT_CONFIG_H)
...
#endif // STORAGE_TAGFILTERDB_PORT_PORT_STDCXX_H_
